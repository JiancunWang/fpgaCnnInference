...
//----------------------[512]----------------------[16]--------------------[1]
apfix32_image_t IBRAM_KL[MAX_WIDTH_X_CHIN_DIV16_KL][NUM_IMG_CACHE_LINES_KL][PE_KL_CI];
//----------[512]------------------------[8]
...
//-------------[256]------------------------[64]
data_t LBRAM_KS[MAX_WIDTH_X_CHIN_DIV16_KS/4][PE_KS_CO];////256x64
...
#pragma HLS RESOURCE variable = IBRAM_KL core = RAM_S2P_BRAM latency = 3
    ...
    printf(" --> winPixKL and bufferPixKS --> pxsStrmValue -->hlsPxsStrm          \n");
#ifndef __SYNTHESIS__
    data_t maxData = 0;
    data_t minData = 127;
#endif
...
//								);
                    ...
                    #pragma HLS unroll
                        IBRAM_KL[xLineId][yLineId][i] = vIBRAM[i+((ciDiv*PE_KS_CI)%WEMEM_1ADOTS_DIV4)];
                    }
                }
                    ...
                    #pragma HLS UNROLL
                        ...
                        // winPixKL No need
                            ...
                            #pragma HLS UNROLL
                                ...
                                bufferPixKS[ciDots][hKernel][KL_SIZE-1] = pixChInColsKS[ciDiv][ciDots][hKernel];
                            }
                        }else{
