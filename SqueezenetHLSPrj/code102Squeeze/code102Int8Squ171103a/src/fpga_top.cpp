...
#if 0
//-------------------------[512]-------[2]------------[4]----[25]
apfix32_weights_t WBRAM_KLA[BLOCK_SIZE][PE_KL_CO_PORT][PE_CI][SQR_KL_SIZE];
//-------------------------[512]-------[4]-------[2]                [2]
apfix32_weights_t BBRAM_KLA[BLOCK_SIZE][BIAS_NUM][WEMEM_1ADOTS_DIV8][PE_KL_CO_PORT];
//----------------------[512]					[8]					 [4]
apfix32_image_t IBRAM_KL[MAX_WIDTH_X_CHIN_DIV16][NUM_IMG_CACHE_LINES][PE_CI];
#endif
//-------------------------[512]-------[1]-------[2]------------[121]
...
apfix32_weights_t BBRAM_KLA[BLOCK_SIZE][BIAS_NUM][WEMEM_1ADOTS_DIV8][PE_KL_CO_PORT];
//----------------------[512]					[8]					 [1]
apfix32_image_t IBRAM_KL[MAX_WIDTH_X_CHIN_DIV16_KL][NUM_IMG_CACHE_LINES][PE_KL_CI];



//----------[512]					[16]
data_t LBRAM[MAX_WIDTH_X_CHIN_DIV16*2][PE_KL_CO];////512x16
...
//								);
                    ...
                    //// here is wrong
                    offset_t xLineId = ( (x * DDR_CH_IN + ciDiv * PE_KL_CI)/(BRAM_1ADOTS * PE_KL_CI) ) % MAX_WIDTH_X_CHIN_DIV16_KL;
                    L_WRITE_TO_IBRAM_KL:
                ...
                if( y >= (KL_SIZE-padSizeExtend) ){
                    ...
                    offset_t iAddr = (pixValidX < 0)?offset_t(0):offset_t(((pixValidX * DDR_CH_IN +ciDiv * PE_KL_CI)/(PE_KL_CI * BRAM_1ADOTS))%MAX_WIDTH_X_CHIN_DIV16_KL);
                    ...
                    #pragma HLS UNROLL
                        ...
                        offset_t offsetY = isPadPixel ? offset_t(0) : offset_t(pixValidY % NUM_IMG_CACHE_LINES);
...
#pragma HLS inline off
    ...
    L_COMPUTE_Y:
    for(dimension_t y = 0; y < heightSize; y++){
...
//					weightsTmpL[coDiv4 * BRAM_1ADOTS + 0][ci][k] = weightsValue[0];
//					weightsTmpL[coDiv4 * BRAM_1ADOTS + 1][ci][k] = weightsValue[1];
//					weightsTmpL[coDiv4 * BRAM_1ADOTS + 2][ci][k] = weightsValue[2];
//					weightsTmpL[coDiv4 * BRAM_1ADOTS + 3][ci][k] = weightsValue[3];
//					weightsL[coDiv4 * BRAM_1ADOTS + 0][ci][k] = 0;
